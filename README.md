...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aws-sso-lib-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13634&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aws-sso-lib-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aws-sso-lib` can be installed with:

```
conda install aws-sso-lib
```

It is possible to list all of the versions of `aws-sso-lib` available on your platform with:
